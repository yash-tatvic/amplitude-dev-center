...
!!! info "Minimum version"
    Refer to [`build.gradle`](https://github.com/amplitude/Amplitude-Android/blob/4e37e0f2d21c437af2b4f4bb58520b061a21a2be/build.gradle#L39) for minimum API level required to use the package.
