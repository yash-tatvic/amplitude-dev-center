...
| `app`                                | int       | Project ID found in your project's Settings page. Example: 123456                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `paying`                             | boolean   | True if the user has ever logged any revenue, otherwise (none).   Note: The property value can be modified via the Identify API. Example: true                                                                                                                                                                                                                                                                                                                                                                                                   |
| `platform`                           | string    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
